...
# in a specific order.
./install_gpg_component.sh --component libgpg-error --component-version latest --sudo \
  --configure-opts "--disable-doc"
./install_gpg_component.sh --component libgcrypt --component-version latest --sudo \
  --build-dir "${BUILD_DIR}"
./install_gpg_component.sh --component libassuan --component-version latest --sudo
./install_gpg_component.sh --component libksba --component-version latest --sudo
./install_gpg_component.sh --component npth --component-version latest --sudo
./install_gpg_component.sh --component pinentry --component-version 1.1.0 --sudo
./install_gpg_component.sh --component gnupg --component-version 2.2.10  --sudo \
